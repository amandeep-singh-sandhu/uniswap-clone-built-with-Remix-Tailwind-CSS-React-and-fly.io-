...
const Features = forwardRef<HTMLDivElement>((props, ref) => {
  const FEATURES = [
    {
      ...
      link: "Trade Tokens",
      image: "bg-[url('public/assets/images/swapCard.png')]",
      target: "/",
    },
    {
      title: "Trade NFTs",
      ...
      link: "Explore NFTs",
      image: "bg-[url('public/assets/images/nftCard.png')]",
      target: "/nfts",
    },
  ];
  ...
  const SUB_FEATURES = [
    {
      ...
      iconUrl: "assets/images/dollarIcon.png",
      link: "Buy now",
      target:
    ...
    },
    {
      ...
      iconUrl: "assets/images/earn.png",
    ...
    },
    {
      ...
      iconUrl: "assets/images/build.png",
      link: "Developer docs",
  ...
  return (
    <>
      {/* 2Col Grid */}
      <div
        className="grid w-full max-w-[1440px] scroll-m-20 grid-cols-2 gap-8 pt-6"
        ref={ref}
      >
