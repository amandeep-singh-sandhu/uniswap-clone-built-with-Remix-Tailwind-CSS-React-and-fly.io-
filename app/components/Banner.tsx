  ...
  return (
    <>
      ...
      <div className="absolute z-[990] flex h-[calc(100vh-124px)] w-full max-w-[min(720px,90%)] flex-col items-center justify-end pb-10">
        <h1 className="mb-6 from-uns-yellow-1 from-10% to-uns-pink-2 to-100% bg-clip-text text-center text-[50px] font-bold leading-[72px] tracking-tighter text-transparent bg-gradient-10">
