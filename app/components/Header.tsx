            ...
            <div className="flex items-center">
              <NavLink
                ...
                className={({
                  ...
                  clsx(
                    "my-1 rounded-xl px-3.5 py-2 tracking-wide text-uns-light-blue transition duration-[250ms] hover:bg-uns-blue-gray",
              ...
              <NavLink
                to="/tokens"
                className="my-1 rounded-xl px-3.5 py-2 tracking-wide text-uns-light-blue transition duration-[250ms] hover:bg-uns-blue-gray"
              >
                Tokens
              </NavLink>
              <NavLink
